...
public class AlphaflowJackson {
        private ObjectMappingCustomer objectMapper;  
      
        public static AlphaflowJackson json() {  
            return new AlphaflowJackson();  
        }  
      
        private AlphaflowJackson() {  
        ...
        public AlphaflowJackson filterIn(String filterName, String... properties) {  
        ...
        public AlphaflowJackson filterOut(String filterName, String... properties) {  
            FilterProvider filterProvider = new SimpleFilterProvider().addFilter(filterName,  
        ...
        public AlphaflowJackson setDateFormate(DateFormat dateFormat) {  
