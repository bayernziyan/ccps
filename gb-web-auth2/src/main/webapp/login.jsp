...
<c:url value="/oauth2" var="base" />
<link type="text/css" rel="stylesheet"
	href="/oauth2/webjars/bootstrap/3.0.3/css/bootstrap.min.css" />
<script type="text/javascript"
	src="/oauth2/webjars/jquery/1.9.0/jquery.min.js"></script>
<script type="text/javascript"
	src="/oauth2/webjars/bootstrap/3.0.3/js/bootstrap.min.js"></script>
<title>tonr</title>
</head>
<body>
	...
	<div class="navbar navbar-default" role="navigation">
		...
		<div class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
					<li><a href="/oauth2/index.jsp">home</a></li>
					<li><a href="/oauth2/sparklr/photos">sparklr pics</a></li>
					<li><a href="/oauth2/facebook/info">facebook
							friends</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="container">
		...
		<form action="/oauth2/login" method="post" role="form">
			<fieldset>
				<legend>
					<h2>Login</h2>
				</legend>
