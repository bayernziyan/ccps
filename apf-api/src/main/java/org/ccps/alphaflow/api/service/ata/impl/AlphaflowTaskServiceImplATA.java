package org.ccps.alphaflow.api.service.ata.impl;
...
import org.ccps.alphaflow.api.dbmapper.ata.AlphaflowFormMapperATA;
...
import org.ccps.alphaflow.api.service.ata.AlphaflowTaskServiceATA;
...
@Service
public class AlphaflowTaskServiceImplATA implements AlphaflowTaskServiceATA{
	
	@Autowired
	private AlphaflowInstanceMapper alphaflowMapper;
	@Autowired
	private AlphaflowFormMapperATA alphaflowFormMapperATA;
	@Autowired
	private AlphaflowFormMapper alphaflowFormMapper;
	@Autowired
	private AlphaflowTaskMapper alphaflowTaskMapper;
	@Autowired
	private AlphaflowTaskMapperATA alphaflowTaskMapperATA;
	@Autowired
		...
		try{
			...
			if(assigners!=null&&assigners.size()>0){
				for(Object obj : assigners ){
					...
					alphaflowFormMapperATA.setNormalItemValueOriginal(wfId,afinsbean.getFormDataId(), formItembean.getId(), assigner, taskId,userId,"");
			...
			alphaflowTaskMapperATA.alphaflowTaskForward(map);
