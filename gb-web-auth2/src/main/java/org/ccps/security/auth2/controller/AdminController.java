package org.ccps.security.auth2.controller;
...
public class AdminController {
	...
	@RequestMapping(path={ "/oauth/user", "/oauth/me" },produces={"application/json"})
	@ResponseBody
	 ...
	 */
	public void setUserApprovalHandler(MyUserApprovalHandler userApprovalHandler) {
