...
public class MyWebRequestTraceFilter extends OncePerRequestFilter implements Ordered {
	 ...
	 */
	public MyWebRequestTraceFilter(TraceRepository traceRepository) {
	...
	protected void enhanceTrace(Map<String, Object> trace, HttpServletResponse response) {
		...
		trace.put("responseBody", value);*/
		
	}
	
/*	public static String readStreamParameterNew(ServletOutputStream in) throws UnsupportedEncodingException, IOException{
		String strResult="";  
	...
	public static String readStreamParameterNew(ServletInputStream in) throws UnsupportedEncodingException, IOException{
		String strResult="";  
		byte[] b = new byte[1024];  
		int i = 0;  
		while ((i = in.read(b)) != -1) {  
