...
public class MyResourceOwnerPasswordTokenGranter extends AbstractTokenGranter {
	...
	protected MyResourceOwnerPasswordTokenGranter(AuthenticationManager authenticationManager, AuthorizationServerTokenServices tokenServices,
	...
	protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
		...
		//String stmp = parameters.get("stmp");
		// Protect from downstream leaks of password
		parameters.remove("password");
		
		
		//if(password == null)password = stmp;
